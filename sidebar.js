...
<div id="sidebar" class="sidebar text-white collapse show" style="position: fixed; width: 250px; background-color: #232323; padding: 20px; transition: width 0.3s ease-in-out, height 0.3s ease-in-out;">
    <h4 style="padding-top: 40px;">Buku Informatika</h4>
